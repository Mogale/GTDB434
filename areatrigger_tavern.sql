...
UPDATE areatrigger_tavern SET name='Sturmwind' WHERE id=2746;
UPDATE areatrigger_tavern SET name='Nesingwary\'s Expedition' WHERE id=98;
UPDATE areatrigger_tavern SET name='Kral der Klingenhauer' WHERE id=262;
UPDATE areatrigger_tavern SET name='Geisterlande, Tranquillen, Top of Inn' WHERE id=4109;
UPDATE areatrigger_tavern SET name='Zangarmarschen, Cenarion Refugee, Outside Inn' WHERE id=4300;
UPDATE areatrigger_tavern SET name='Wälder von Terokkar, Stonebreaker Hold, Inn' WHERE id=4378;
UPDATE areatrigger_tavern SET name='Höllenfeuerhalbinsel, Falkenwacht, Inn' WHERE id=4380;
UPDATE areatrigger_tavern SET name='Vorgebirge des Alten Hügellands, Inn' WHERE id=4498;
UPDATE areatrigger_tavern SET name='Vorgebirge des Alten Hügellands, behind Inn' WHERE id=4502;
UPDATE areatrigger_tavern SET name='Schattenmondtal, Wildhammer Stronghold, Inn bedroom' WHERE id=4529;
UPDATE areatrigger_tavern SET name='Schattenmondtal, Sanctum Of The Stars, Inn, in air' WHERE id=4608;
UPDATE areatrigger_tavern SET name='Wyrmrest - Dragonblight inn' WHERE id=5314;
UPDATE areatrigger_tavern SET name='Wyrmrest Temple' WHERE id=5315;
UPDATE areatrigger_tavern SET name='Wyrmrest Temple' WHERE id=5316;
UPDATE areatrigger_tavern SET name='Wyrmrest Temple' WHERE id=5317;
